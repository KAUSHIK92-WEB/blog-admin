                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm flex gap-3">
                                <button wire:click="edit({{ $category->id }})" class="text-indigo-600 hover:text-indigo-900 font-semibold">Edit</button>
                                <button wire:click="delete({{ $category->id }})" class="text-red-600 hover:text-red-900 font-semibold" onclick="confirm('Are you sure?') || event.stopImmediatePropagation()">Delete</button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
